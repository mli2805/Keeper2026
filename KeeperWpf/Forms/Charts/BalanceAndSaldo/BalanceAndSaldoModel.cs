...
public class BalanceAndSaldoModel
{
    ...
    public BarSeries MonthlySaldoSeries { get; set; }
    public BarSeries AnnualSaldoSeries { get; set; }
    ...
    private void RegisterDay(TransactionModel tran)
    {
        ...
        if (_currentDate.Month != _previousDate.Month)
        {
            if (_previousDate.Year != 2001)
            {
                ...
                MonthlySaldoSeries.Items.Add(new BarItem(_balanceInUsd - _previousMonth, _monthIndex));
                _monthIndex++;
            }
        ...
        if (_currentDate.Year != _previousDate.Year)
        {
            if (_previousDate.Year != 2001)
            {
                ...
                AnnualSaldoSeries.Items.Add(new BarItem(_balanceInUsd - _previousYear, _yearIndex));
                _yearIndex++;
            }
