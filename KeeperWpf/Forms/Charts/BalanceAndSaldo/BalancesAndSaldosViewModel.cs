...
public class BalancesAndSaldosViewModel : Screen
{
    ...
    private void InitializeMonthlyAndAnnualSaldo(BalanceAndSaldoModel model)
    {
        ...
        MonthlySaldoModel.Axes.Add(new CategoryAxis() { ItemsSource = model.MonthLabels.ToArray() });
        AnnualSaldoModel.Axes.Add(new CategoryAxis() { ItemsSource = model.YearLabels.ToArray() });
    }
