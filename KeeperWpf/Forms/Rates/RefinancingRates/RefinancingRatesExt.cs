...
public static class RefinancingRatesExt
{
    ...
    public static void UpdateRateLinesInConditions(this KeeperDataModel keeperDataModel, DepoCondsModel conditions)
    {
        ...
        if (conditions.RateLines.Count == 0)
        {
            ...
            var depositRateLine = CreateDepositRateLine(lastBeforeDepositStarts, conditions);
        ...
        {
            conditions.RateLines.Add(CreateDepositRateLine(refinancingRate, conditions));
        }
    }

    private static DepositRateLine CreateDepositRateLine(RefinancingRate refinancingRate, DepoCondsModel conditions)
    {
